...
exampleButton.addEventListener("mouseout", () => {
    exampleButton.style.backgroundColor = "#EFEFEF";
    exampleButton.style.color = "black";
})
...
// CODE HERE
exampleButton.addEventListener('click', sayHello)
...
const repeatMyParam = () => {
    ...
    axios.get(`http://localhost:3000/repeat/'Jackson'`)
    .then(res => {
...
// CODE HERE
const querySend = () => {
    axios.get(`http://localhost:3000/query-test/?xx=Jackson-is-the-coolest`)
    .then(res => {
        console.log(res.data)
    })
    .catch(err => {
...
const queryButton = document.getElementById('query-button').addEventListener('click', querySend)
